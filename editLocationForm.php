        ...
        <div class="content">
            <div class="container">
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="FirstName" class="col-md-2 control-label"> First Name</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="FirstName" name="FirstName" value="<?php echo $row['FirstName']; ?>" /><!--input with current data from database-->
                        </div> 
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="LastName" class="col-md-2 control-label"> Last Name</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="LastName" name="LastName" value="<?php echo $row['LastName']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                            <span id="mNameError" class="error"></span><!--error message for invalid input-->
                        </div>
                    ...
                    <div class="form-group">
                        <label for="Email" class="col-md-2 control-label"> Email</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="Email" name="Email" value="<?php echo $row['Email']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="Number" class="col-md-2 control-label"> Number</label><!--label-->
                        <div class="col-md-5">
                            <input type="number" class="form-control" id="Number" name="Number" value="<?php echo $row['Number']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
