                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                Sitting amongst historic sandstone, the Forest Hotel Private Dining Room
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Forest Hotel Private Dining Room</h1><!--location title-->
                            <p class="location"><!--location secondary content-->
                            Bantug Roxas, Isabela
                            </p>
                            <p class="definition"><!--content body-->
                            Sitting amongst historic sandstone, the Forest Hotel Private Dining Room
                            is the epitome of elegance for a sophisticated celebration.When you dine in the 
                            Forest Hotel Private Dining Room, you can choose from our award winning Saké Restaurant
                            & Bar menu served banquet style, or an elegant menu from The Life Bar & Grill.
                            </p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Splash Kitchen and Lounge</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>A CORNER OF CITY IN THE ROCKS</h5><!--content title-->
                                                <p>
                                                Champagne imbibing, glamorous, smiling and flirting, Splash Kitchen and Lounge
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Splash Kitchen and Lounge </h1><!--location title-->
                            <p class="location">66 Lion's Rd, Mandaluyong, 1550 Metro</p><!--location secondary content-->
                            <p class="definition">
                            This breathtaking venue bring shimmering glamour to The Rocks.
                ...
                <section>
                    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                ...
                                                <p>
                                                There’s no question that The Rocks is home to some of Pilipino's most intriguing historical stories. And
                                                our landmark venue, Bantug Roxas, has a unique, rich history all of its own.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">La Kusina</h1>
                            <p class="location">Bantug Roxas Isabela</p>
                            <p class="definition">There’s no question that The Rocks is home to some of Sydney’s most intriguing historical stories.
                                And our landmark venue, Bantug Roxas , has a unique, rich history all of its own. The sandstone walls that house
                                La Kusina had seen some interesting sights well before we all hit the dance floor.</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE BEST PRIVATE DINING ROOM IN MAKATI</h5>
                                                <p>
                                                Experience Oktoberfest 365 days of the year with uber biers, parties and food at this 1000-strong Filipino-styled restaurant,
                                                located in the heart of Makati City.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                ...
                                                over 900 people and is located opposite the Makati Convention & Exhibition Centre, overlooking Makati City.
                                                </p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Private Dining Room</h1>
                            <p class="location">45 Makati City</p>
                            <p class="definition">The uber venue is our latest venture, bringing to life a traditional
                                ...
                                The state-of-the-art venue seats over 900 people and is located opposite the Makati
                                Convention & Exhibition Centre, overlooking Makati City.</p>
                            <hr class="customline3">   
